var jsheader = new function() {
	...
	this.showreg = function() {
		...
		if("reg" in this.html) {
			...
			kj.ajax.get("/index.php/index/reg" , function(data) {
	...
	this.comment_shop = function(shop_id) {
		kj.dialog({id:'comment',title:'店铺评论',url:kj.cfg('baseurl') + '/index.php?app_act=comment.shop&shop_id='+shop_id,w:600,h:500,showbtnhide:false,showbtnmax:false,type:'iframe'});
	}
