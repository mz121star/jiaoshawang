		...
		function c(a, f, b) {
			...
			if (b && n && (i || p)) {
				...
				for (e = f.length; 0 < e; e -= 1) {
					c = f.slice(0, e).join("index.html");
					if (i) {
						for (m = i.length; 0 < m; m -= 1) {
							if (b = l(n, i.slice(0, m).join("index.html"))) {
								if (b = l(b, c)) {
									g = b;
									d = e;
									break
				...
				g && (f.splice(0, d, g), a = f.join("index.html"))
			}
			return a
		}
		function d(a) {
			...
			nameToUrl: function(a, b, c) {
				...
				if (j.jsExtRegExp.test(a)) {
					...
					for (i = g.length; 0 < i; i -= 1) {
						if (n = g.slice(0, i).join("index.html"), h = l(d, n), n = l(e, n)) {
							I(n) && (n = n[0]);
							g.splice(0, i, n);
							break
						} else {
					...
					g = g.join("index.html");
					g += b || (/\?/.test(g) || c ? "" : ".js");
					g = ("index.html" === g.charAt(0) || g.match(/^[\w\+\.\-]+:/) ? "" : k.baseUrl) + g;
				}
	...
	if ("undefined" === typeof define) {
		...
		z && M(document.getElementsByTagName("script"), function(b) {
			...
			if (J = b.getAttribute("data-main")) {
				return q = J, t.baseUrl || (D = q.split("/"), q = D.pop(), fa = D.length ? D.join("index.html") + "index.html" : "./", t.baseUrl = fa), q = q.replace(ea, ""), j.jsExtRegExp.test(q) && (q = J), t.deps = t.deps ? t.deps.concat(q) : [q], !0
			}
		});
...
var Zepto = function() {
		...
		function O(a) {
			return a.replace(/::/g, "index.html").replace(/([A-Z]+)([A-Z][a-z])/g, "$1_$2").replace(/([a-z\d])([A-Z])/g, "$1_$2").replace(/_/g, "-").toLowerCase()
		}
		function P(a) {
