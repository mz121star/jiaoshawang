...
INSERT INTO `dc_shoptype` VALUES (4, '水果店', 0, 3,'fruit');
INSERT INTO `dc_shoptype` VALUES (5, '电脑店', 0, 8,'computer');
...
CREATE TABLE `dc_order` (
  ...
  `order_status` enum('1','2','3','4') NOT NULL COMMENT '订单状态，1是正常，2是完结，3是取消，4是申请取消',
